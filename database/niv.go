...
func (c Client) GetAllVerseByChapter(ctx context.Context, bookId string, chapterId int) ([]models.NIV , error){
	var verse []  models.NIV
...
func (c Client) GetAllChapter(ctx context.Context,bookId string) ( ChapterMaxDTO , error){
